...
fun daysInMonth(month: Int, year: Int): Int {
    ...
    when {
        month == 2 && !leapYear -> return 28
        month == 2 && leapYear -> return 29
...
fun circleInside(
    ...
    return if (sqrt(((x2 - x1) * (x2 - x1)) + ((y2 - y1) * (y2 - y1))) + r1 <= r2) true
    else false
}
 ...
 */
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean = (((a <= r) && ((b <= s) || (c <= s))) ||
        ((b <= r) && ((a <= s) || (c <= s))) || ((c <= r) && ((b <= s) || (a <= s))))
