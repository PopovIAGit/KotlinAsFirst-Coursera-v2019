...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val varshokSum = vershoks + (arshins * 16) + (sagenes * 48)
    return (varshokSum * 4.445) / 100
}
...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
    val degToRadian = PI / 180
    return deg * degToRadian + (min / 60.0) * degToRadian + (sec / 3600.0) * degToRadian
}
